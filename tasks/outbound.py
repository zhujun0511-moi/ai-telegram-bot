...
2026-07-10（同一天，另一輪整頓）：COMM_HUB_URL 統一為根網址慣例，
notify() 原本直接把它當完整 /comm/send URL 打，現在改成拼路徑，比照
DC/AC同一輪的root-URL統一（trigger_ac_webhook()的ANALYSIS_HUB_URL本來
就是07-07就定下的根網址寫法，不受影響）。
